...
\1\1\&{int} \\{main}(\&{int} \\{argc}${},\39{}$\&{char} ${}{*}\\{dmin}[\,])\2%
\2{}$\6
${}\{{}$\1\6
\&{Graph} ${}{*}\|g;{}$\6
...
degree\X;\6
${}\\{len}(\|v\K\|g\MG\\{vertices};{}$ ${}\|v<\|g\MG\\{vertices}+\|g\MG\|n;{}$
${}\|v\PP)\\{sscanf}(\.{"\ \%ld"},\39\|v\MG\\{deg});{}$\6
\\{sscanf}(\.{"\\n"});\C{ TEMPORARY CHECK }\6
\&{if} ${}(\|x\MG\\{deg}<\T{2}){}$\5
${}\{{}$\1\6
${}\\{sscanf}(\.{"The\ minimum\ degree\ }\)\.{is\ \%ld\ (vertex\ \%s)!\\}\)%
\.{n"},\39\|x\MG\\{deg},\39\|x\MG\\{name});{}$\6
\&{return} ${}{-}\T{1};{}$\6
\4${}\}{}$\2\7
\1\1${}\\{len}(\|b\K\|x\MG\\{arcs};{}$ ${}\|b\MG\\{next};{}$ ${}\|b\K\|b\MG%
\\{next})\\{len}(\\{bb}\K\|b\MG\\{next};{}$ \\{bb}; ${}\\{bb}\K\\{bb}\MG%
\\{next})\2\2{}$\6
${}\{{}$\1\6
${}\|v\K\|b\MG\\{tip};{}$\6
${}\|z\K\\{bb}\MG\\{tip};{}$\6
...
\4${}\}{}$\2\7
${}\\{sscanf}(\.{"Altogether\ \%d\ solut}\)\.{ions.\\n"},\39\\{count});{}$\6
${}\\{len}(\|v\K\|g\MG\\{vertices};{}$ ${}\|v<\|g\MG\\{vertices}+\|g\MG\|n;{}$
${}\|v\PP)\\{sscanf}(\.{"\ \%ld"},\39\|v\MG\\{deg});{}$\6
...
\&{if} ${}(\\{argc}>\T{1}){}$\1\5
${}\|g\K\\{restore\_graph}(\\{dmin}[\T{1}]){}$;\5
\2\&{else}\1\5
${}\|g\K\NULL;{}$\2\6
\&{if} ${}(\\{argc}<\T{3}\V\\{sscanf}(\\{dmin}[\T{2}],\39\.{"\%d"},\39{\AND}%
\\{modulus})\I\T{1}){}$\1\5
...
$\\{dmin}\K\|g\MG\|n;{}$\7
\1\1${}\\{len}(\|v\K\|g\MG\\{vertices};{}$ ${}\|v<\|g\MG\\{vertices}+\|g\MG%
\|n;{}$ ${}\|v\PP)\2\2{}$\6
${}\{{}$\1\6
${}\|v\MG\\{taken}\K\T{0};{}$\6
${}\|d\K\T{0};{}$\6
${}\\{len}(\|a\K\|v\MG\\{arcs};{}$ \|a; ${}\|a\K\|a\MG\\{next})\|d\PP;{}$\6
${}\|v\MG\\{deg}\K\|d;{}$\6
\&{if} ${}(\|d<\\{dmin}){}$\1\5
...
\&{goto} \\{backtrack};\6
\4${}\}{}$\2\7
\1\1${}\\{len}(\\{aa}\K\|v\MG\\{arcs},\39\|y\K\NULL;{}$ \\{aa}; ${}\\{aa}\K%
\\{aa}\MG\\{next})\2\2{}$\6
${}\{{}$\1\6
${}\|u\K\\{aa}\MG\\{tip};{}$\6
${}\|d\K\|u\MG\\{deg}-\T{1};{}$\6
...
\|t} was entered\X${}\E{}$\6
$\\{len}(\|a\K\|t\MG\\{vert}\MG\\{arcs};{}$ ${}\|a\I\\{aa};{}$ ${}\|a\K\|a\MG%
\\{next})\|a\MG\\{tip}\MG\\{deg}\PP{}$;\par
\U4.
\mini
\[1 \|{a} \&{register} \&{Arc} ${}{*}{}$
\[1 \\{aa} \&{register} \&{Arc} ${}{*}{}$
...
${}\{{}$\1\6
${}\\{sscanf}(\.{"\%d:\ "},\39\\{count});{}$\6
${}\\{len}(\|u\K\|g\MG\\{vertices};{}$ ${}\|u\Z\\{tmax};{}$ ${}\|u\PP)%
\\{sscanf}(\.{"\%s\ "},\39\|u\MG\\{vert}\MG\\{name});{}$\6
\\{sscanf}(\.{"\\n"});\6
\4${}\}{}$\2\6
\4${}\}{}$\2\par
\U5.
