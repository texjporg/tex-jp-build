...
あ）\inhibitglue\unbox （あ\par       % ベタ【修正前：二分アキ】
あ）\unbox\inhibitglue\unbox （あ\par % 二分アキ
あ）\unbox （あ\par                   % 全角アキ
\setbox200=\hbox{漢}
あ）\inhibitglue （あ\par             % ベタ
...
あ\inhibitglue\setbox0=\vbox{『}（\par % ベタ
あ\setbox0=\hbox{\inhibitglue}（\par   % 二分アキ
）\setbox0=\hbox{\inhibitglue}（\par   % 全角アキ

あ\setbox0=\vbox{\hsize10zw【}（い\box0\par % （前：二分，【前：二分
あ\setbox0=\vbox{\hsize10zw【\inhibitglue}（い\box0\par % （前：二分，【前：二分
あ\inhibitglue\setbox0=\vbox{\hsize10zw【}（い\box0\par % （前：ベタ，【前：二分
